...
public class MyBackgroundService extends Service {
    ...
    private static final String EXTRA_STARTED_FROM_NOTIFICATION = "com.google.android.gms.location.LocationServices"+
    ...
    public void onCreate() {
        ...
        getLastLocation();
        HandlerThread handlerThread = new HandlerThread("Shantanu1");
        handlerThread.start();
    ...
    public void removeLocationUpdates() {
        try {
            ...
            Log.e("Shantanu", "Lost location permission. Could not remove updates. "+ex);
        }
    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            if(task.isSuccessful() && task.getResult() != null) {
                                ...
                                Log.e("Shantanu","Failed to get location");
                            }
                        }
                    });
        } catch (SecurityException ex) {
            Log.e("Shantanu", "Lost Location Permission. "+ex);
        }
    }
    ...
    public void requestLocationUpdates() {
        ...
        try {
            ...
            Log.e("Shantanu", "Lost location permission. Could not request it. "+ex);
        }
    }
